...
public class SecurityConfig {
    ...
    private static final String[] PUBLIC_URLS = { "/user/verify/password/**",
            ...
            "/user/refresh/token/**", "/user/image/**","user/list/**", "/purchaseRequisition/**","principalpurchase-requisition/**","stock/add","stock/delete/**","stock/check/**","stock/totalQuantity/**","users/{userId}/**" };
